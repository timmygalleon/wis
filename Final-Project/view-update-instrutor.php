...
if(isset($_POST['update'])){
  ...
  $eid =$_GET['editid'];
    ...
    $subject = $_REQUEST['subject'];
     ...
     $sql =mysqli_query($conn, "UPDATE `instructor` SET `FirstName`='$fname',`LastName`='$lname',`Email`='$email',`Phone`='$contact',`TeachingSubject`='$subject' WHERE InstructorID='$eid'");
  ...
  <?php
    ...
    <form  method="post">
      ...
      <div class="input-field" style="width: 85%;">
        <label>Instructor Subject</label>
       


        <div class="custom-select">
  <input style="width: 100%;" type="text" name="subject" placeholder="Instructor Subject" readonly value="<?php echo htmlentities($row['TeachingSubject'])?>" >
  <div class="dropdown-content">
    <a href="#">MOBILE APPLICATION DESIGN AND DEVELOPMENT</a>
    <a href="#">EMERGING TECHNOLOGIES IN IT</a>
    <a href="#">WEB INFORMATION SYSTEM</a>
    <a href="#">CAPSTONE PROJECT</a>
    <a href="#">THE CONTEMPORARY WORLD</a>
  </div>
